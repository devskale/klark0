...
function SidebarTrigger({
  className,
  onClick,
  asChild = false, // Explicitly destructure and default asChild
  children,        // Destructure children
  variant = "ghost", // Default variant for the internal button if asChild is false
  size = "icon",   // Default size for the internal button if asChild is false
  ...props         // Remaining props
}: React.ComponentProps<typeof Button>) { // Type already includes asChild, children, variant, size
  ...
  if (asChild) {
    // If SidebarTrigger is used with asChild, it renders a Slot.
    // The 'children' passed to SidebarTrigger become the children of Slot.
    // Slot then merges commonTriggerProps and other props onto these children.
    return (
      <Slot
        className={className} // Pass className to Slot for merging with the child's className
        {...commonTriggerProps}
        {...props} // Spread other props (e.g., aria-attributes from user, other Button variants if any)
      >
        {children}
      </Slot>
    );
  ...
  // Default behavior: SidebarTrigger renders its own Button.
