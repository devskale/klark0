...
export async function GET(request: NextRequest) {
  try {
    ...
    const workerTypes = [
      {
        id: 'parsing',
        name: 'StruktText',
        description: 'Konvertiert alle Projektdokumente in strukturierte Textformate, die als Basis für weitere Analysen dienen.',
      ...
      },
      {
        id: 'anonymization',
        name: 'Anonymisierung',
        description: 'Entfernt oder maskiert persönliche und sensible Daten aus Dokumenten.',
      ...
      },
      {
        id: 'analysis',
        name: 'KI-Analyse',
        description: 'Führt tiefgreifende KI-basierte Analysen der Ausschreibungsdokumente durch.',
      ...
      },
      {
        id: 'fakejob',
        name: 'FAKEJOB',
        description: 'Test-Worker für Entwicklung und Debugging. Läuft zufällig zwischen 3 und konfigurierbaren Sekunden.',
        category: 'testing',
    ...
    const systemStatus = {
      ...
      availableWorkers: workerTypes.filter(w => w.status === 'available').length
    };
